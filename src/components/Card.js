...
function Card({
    ...
    function updateItem(e) {
        ...
        // Update the field of the services
        return serviceRef
            .update({title: formValuesUpdate.serviceName, description: formValuesUpdate.description, cost: formValuesUpdate.price, imageurl: updateImgUrl})
            .then(() => {
                ...
                <div className="relative px-4 -mt-5  ">
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <div className="mt-4">
                            ...
                            {(isAdmin) &&<> <ButtonRed btnValue="Delete" onClickFunc={openModalDelete}/> < ButtonGreen btnValue = "Update" onClickFunc = {openModalUpdate}/> </>
}
                            {/*Delete modal */}
                            <Modal
